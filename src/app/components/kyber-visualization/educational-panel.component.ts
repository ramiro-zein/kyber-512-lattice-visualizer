      ...
      concepts: [
        {
          ...
          description:
            'Kyber opera en el anillo de polinomios módulo X^256 + 1 con coeficientes en ℤ3329. Este anillo ciclotómico proporciona estructura algebraica eficiente para operaciones criptográficas.',
          formula: 'R = ℤ₃₃₂₉[X]/(X²⁵⁶ + 1)',
          importance: 'high',
        },
        {
          ...
          description:
            'Matriz de polinomios uniformemente aleatorios generada a partir de una semilla pública. En Kyber-512, K=2, resultando en una matriz 2×2.',
          formula: 'A ∈ Rq^(K×K)',
          importance: 'high',
        },
        {
          ...
          description:
            'Los secretos y errores se muestrean de CBD con parámetro η=2. Esto garantiza coeficientes pequeños mientras mantiene suficiente entropía para seguridad.',
        ...
        },
        {
          ...
          description:
            'La llave pública se calcula multiplicando la matriz A por el secreto s y añadiendo error e. Esta construcción oculta s mediante el problema LWE.',
          formula: 't = A·s + e ∈ Rq^K',
          importance: 'medium',
        },
      ],
      securityNote:
        'La seguridad de Kyber se basa en Module-LWE (Learning With Errors sobre módulos), considerado resistente a ataques cuánticos. NIST estima seguridad equivalente a AES-128 (Nivel 1) para Kyber-512.',
    },
      ...
      concepts: [
        {
          ...
          description:
            'El bit m se codifica como el primer coeficiente de un polinomio: m=0 → 0, m=1 → ⌊q/2⌋ = 1664. Esto maximiza la distancia entre valores para robustez contra ruido.',
        ...
        },
        {
          ...
          description:
            'Se generan nuevos vectores de ruido usando CBD. Estos introducen aleatoriedad fresca en cada encriptación, garantizando seguridad IND-CCA.',
        ...
        },
        {
          ...
          description:
            'Primera parte del ciphertext calculada como u = A^T·r + e₁. Esto "oculta" el vector aleatorio r usando la matriz pública A.',
        ...
        },
        {
          ...
          description:
            'Segunda parte que lleva el mensaje codificado: v = t^T·r + e₂ + encode(m). El mensaje queda protegido por el producto interno con la llave pública.',
          formula: 'v = tᵀ·r + e₂ + encode(m) ∈ Rq',
          importance: 'high',
        },
      ],
      securityNote:
        'El ciphertext (u, v) es indistinguible de uniforme bajo el problema Module-LWE. Cada encriptación usa ruido fresco, garantizando semántica segura contra adversarios cuánticos.',
    },
      ...
      concepts: [
        {
          ...
          description:
            'El primer paso calcula s^T·u = s^T(A^T·r + e₁). Expandiendo: s^T·A^T·r + s^T·e₁. Este término aproxima t^T·r debido a que t ≈ As.',
        ...
        },
        {
          ...
          description:
            "Restando s^T·u de v: m' = (t^T·r + e₂ + m) - (s^T·A^T·r + s^T·e₁). Dado que t ≈ As, los términos principales se cancelan, dejando m más ruido.",
        ...
        },
        {
          ...
          description:
            'El ruido acumulado es e_total = e₂ + s^T·e₁ - e^T·r. Por CBD, este ruido es suficientemente pequeño para no cruzar los umbrales de decodificación con alta probabilidad.',
          formula: '||e_total||∞ < ⌊q/4⌋ con prob ≈ 1 - 2^(-128)',
          importance: 'medium',
        },
      ],
      securityNote:
        'La probabilidad de error de decodificación en Kyber-512 es < 2^(-139), garantizando correctitud práctica. El análisis de ruido es crucial para la seguridad y correctitud del esquema.',
    },
  };
